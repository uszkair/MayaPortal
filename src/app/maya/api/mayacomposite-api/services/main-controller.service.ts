...
import { sayHello } from '../fn/main-controller/say-hello';
import { SayHello$Params } from '../fn/main-controller/say-hello';

@Injectable({ providedIn: 'root' })
export class MainControllerService extends BaseService {
  constructor(config: ApiConfiguration, http: HttpClient) {
    super(config, http);
  }

  /** Path part for operation `sayHello()` */
  static readonly SayHelloPath = '/main/hello';
